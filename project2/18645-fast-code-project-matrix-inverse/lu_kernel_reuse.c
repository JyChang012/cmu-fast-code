...
int lu_kernel(double *matrixA, int i, int m, int n, int N){
    ...
    a11 = _mm256_broadcast_sd(&matrixA[(n)*N+i]); // a12t -- reuse a11 register

    A2211 = _mm256_fmsub_pd (a11, a211, A2211);
    A2221 = _mm256_fmsub_pd (a11, a212, A2221);
    A2231 = _mm256_fmsub_pd (a11, a213, A2231);
    a11 = _mm256_broadcast_sd(&matrixA[(n+1)*N+i]);
    A2212 = _mm256_fmsub_pd (a11, a211, A2212);
    A2222 = _mm256_fmsub_pd (a11, a212, A2222);
    A2232 = _mm256_fmsub_pd (a11, a213, A2232);
    a11 = _mm256_broadcast_sd(&matrixA[(n+2)*N+i]);
    A2213 = _mm256_fmsub_pd (a11, a211, A2213);
    A2223 = _mm256_fmsub_pd (a11, a212, A2223);
    A2233 = _mm256_fmsub_pd (a11, a213, A2233);
    a11 = _mm256_broadcast_sd(&matrixA[(n+3)*N+i]);
    A2214 = _mm256_fmsub_pd (a11, a211, A2214);
    A2224 = _mm256_fmsub_pd (a11, a212, A2224);
    A2234 = _mm256_fmsub_pd (a11, a213, A2234);
    
    // step4 -- * -1
    a11 =  _mm256_set_pd (-1.0, -1.0, -1.0, -1.0); // s: -1 reuse a11 register

    A2211 = _mm256_mul_pd(A2211, a11);
    A2221 = _mm256_mul_pd(A2221, a11);
    A2231 = _mm256_mul_pd(A2231, a11);

    A2212 = _mm256_mul_pd(A2212, a11);
    A2222 = _mm256_mul_pd(A2222, a11);
    A2232 = _mm256_mul_pd(A2232, a11);

    A2213 = _mm256_mul_pd(A2213, a11);
    A2223 = _mm256_mul_pd(A2223, a11);
    A2233 = _mm256_mul_pd(A2233, a11);

    A2214 = _mm256_mul_pd(A2214, a11);
    A2224 = _mm256_mul_pd(A2224, a11);
    A2234 = _mm256_mul_pd(A2234, a11);
